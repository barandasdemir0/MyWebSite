...
public class CreateMessageValidator:AbstractValidator<CreateMessageDto>
{
    public CreateMessageValidator()
    {
        ...
        RuleFor(x => x.SenderName).NotEmpty()
            ...
            .MaximumLength(100)
            .WithMessage("Lütfen Normal Uzunluklarda ad ve soyad giriniz 100 karakterden fazla olmamalı").MustBeSafeHtml();
        ...
        RuleFor(x => x.Subject).NotEmpty()
          ...
          .MaximumLength(200)
          .WithMessage("Lütfen Normal Uzunluklarda konu giriniz 100 karakterden fazla olmamalı").MustBeSafeHtml();
        ...
        RuleFor(x => x.Body).NotEmpty()
          ...
          .WithMessage("Konu Alanı Sadece Boşluklardan oluşamaz")
          .MinimumLength(5)
          .WithMessage("Lütfen Normal uzunluklarda konu giriniz 5 karakterden az olmamalı").MustBeSafeHtml();
